module.exports = function (eleventyConfig) {
    ...
    // Custom Sidebar
    eleventyConfig.addPairedShortcode("customSidebar", function(content, {id, side = "", colour_backdrop = "", dark_colour_backdrop = ""}) {
        return `
        <div class="md:hidden">
            ...
            <aside id="${id}" class="z-20 fixed top-0 right-0 w-full max-w-xs h-screen 
